...
export const textJa: Text = {
  ABOUT: {
    DESCRIPTION1:
      'はじめまして、橋本水輝といいます。最近、Juniata Collegeをコンピューターサイエンス専攻 \
    ...
    DESCRIPTION2:
      'デベロッパーとしては、ソフトウェアを集合体として捉え、各構成物がなにで、何をして、\
  ...
  EXPERIENCES: [
    {
      ...
      DESCRIPTION:
        'フロントエンドエンジニアとしてプロダクトチームと協力し、ウェブアプリケーションの新機能開発、\
      リファクタリング、バグ修正等に携わる。',
    },
    {
      POSITION: 'プロジェクトメンバー',
      DESCRIPTION:
        'スケジュールに沿って社内のデータベースからデータを取り出しレポートを作成するシステムを実装し、\
